const {homeMenuItemsGet,homeMenuItemAdd,homeMenuItemDelete,homeMenuItemEdit,homeMenuSwapItems} = require('../../modules/home_menu_items');
...
exports.swap = async ({params:{id1,id2}}, res) => {
    ...
    homeMenuSwapItems(id1,id2).finally(() => res.redirect("/homeMenu"))
